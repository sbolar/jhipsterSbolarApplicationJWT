...
class JhipsterSbolarApplicationJwtKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSbolarApplicationJwtKafkaResource kafkaResource = new JhipsterSbolarApplicationJwtKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sbolar-application-jwt-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sbolar-application-jwt-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
