...
@RestController
@RequestMapping("/api/jhipster-sbolar-application-jwt-kafka")
public class JhipsterSbolarApplicationJwtKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSbolarApplicationJwtKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSbolarApplicationJwtKafkaResource(KafkaProperties kafkaProperties) {
